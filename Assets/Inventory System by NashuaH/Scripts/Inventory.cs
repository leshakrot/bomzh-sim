...
public class Inventory : MonoBehaviour
{
    ...
    private Vector3 _removedItemSpawnOffset;
    ...
    public void Start()
    {
        ...
        _player = FirstPersonController.instance.gameObject;
    }
    ...
    public void RemoveItem(Item itemRemoved, int quantityRemoved)
    {
        ...
        UpdateInventoryUI();
        Instantiate(itemRemoved.prefab, _player.transform.position + _player.transform.forward, transform.rotation);
    }
