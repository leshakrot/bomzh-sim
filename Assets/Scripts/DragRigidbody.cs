...
public class DragRigidbody : MonoBehaviour
{
	...
	public float distance = 5; // максимальная дистанция, с которой можно схватить объект
	public float maxMass = 10; // максимальная масса объекта, который можно поднять
	public float stopDistance = 1; // допустимое расстояние от точки назначения и текущего положения объекта, при перемещении (чтобы нельзя было перетащить предмет сквозь графику)
